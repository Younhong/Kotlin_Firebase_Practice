        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
                ...
                .document(alarmDTOList[position].uid!!).get().addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        ...
                        Glide.with(view.context).load(url).apply(RequestOptions().circleCrop())
                            .into(view.commentview_item_imageview_profile)
                    }
                }
            ...
            when(alarmDTOList[position].kind) {
                0 -> {
                    ...
                    view.commentview_item_textview_profile.text = str_0
                }
                1 -> {
            ...
            view.commentview_item_textview_comment.visibility = View.INVISIBLE
        }
